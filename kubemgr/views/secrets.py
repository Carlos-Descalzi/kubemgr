...
class SecretsListModel(AsyncListModel):
    ...
    def fetch_data(self):
        ...
        if cluster:
            ...
            if self._namespace:
                configmaps = core_api.list_namespaced_secret(self._namespace)
            else:
                configmaps = core_api.list_secret_for_all_namespaces()
...
class SecretsListView(ResourceListView):
